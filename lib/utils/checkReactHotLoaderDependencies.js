...
module.exports = function checkReactRefreshDependencies() {
    return new Promise(async (resolve) => {
        infoLog( 'check react-refresh dependencies...' );
        ...
        infoLog( `check react-refresh dependencies in ${targetPackageJsonPath}...` );
        ...
        const isDone = await runCommand('npm', ['install', '--save-dev', '--legacy-peer-deps', `react-refresh@${curr_v}`]);
        if ( isDone ) {
